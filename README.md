...
-p 8081:80 ---> link between the port 80 of the Container and port 8081 of the host.
  ...
  You can use docker ngnix for do a proxy reverse and mapping in domaine or sub domain:

  docker build -t jancelin/nginx-proxy git://github.com/jancelin/nginx-proxy
